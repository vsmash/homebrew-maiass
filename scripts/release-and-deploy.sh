...
MAIASS_DIST_DIR="/Volumes/enigmadev/enigmadev/static/maiass-whole/maiass-dist"
HOMEBREW_REPO_DIR="/Volumes/enigmadev/enigmadev/static/maiass-whole/homebrew-bashmaiass"
